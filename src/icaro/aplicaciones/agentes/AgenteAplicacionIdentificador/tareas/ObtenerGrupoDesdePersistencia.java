...
public class ObtenerGrupoDesdePersistencia extends TareaSincrona {
	...
	public void ejecutar(Object... params) {
		...
		try {
			...
			ItfUsoComuSONIAChat recComunicacionChat = (ItfUsoComuSONIAChat) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfazUso(VocabularioGestionQuedadas.IdentRecursoComunicacionChat);
