...
public class DccChat {
	 ...
	 */
	private ConexionSONIA _bot;
	private String _sourceNick;
	private BufferedReader _reader;
	private BufferedWriter _writer;
	private Socket _socket;

	public DccChat(ConexionSONIA bot, String sourceNick, String address, int port)
			throws IOException {
		_bot = bot;
	 ...
	 */
	public DccChat(ConexionSONIA bot, String sourceNick, Socket socket)
			throws IOException {
		_bot = bot;
		_sourceNick = sourceNick;
		_socket = socket;
